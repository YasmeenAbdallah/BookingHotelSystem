    ...
    public partial class intial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BranchRooms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BranchRooms_Branch_BranchID",
                        column: x => x.BranchID,
                        principalTable: "Branch",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BranchRooms_RoomType_RoomTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reservations_User_AppUserId",
            ...
            migrationBuilder.CreateTable(
                name: "ReseverationDetails",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NumOfAdults = table.Column<int>(type: "int", nullable: false),
                    NumOfChildern = table.Column<int>(type: "int", nullable: false),
                    RoomTypeId = table.Column<int>(type: "int", nullable: false),
                    ReservationsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReseverationDetails", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReseverationDetails_RoomType_RoomTypeId",
                        column: x => x.RoomTypeId,
                        principalTable: "RoomType",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BranchRooms_BranchID",
                table: "BranchRooms",
                column: "BranchID");

            migrationBuilder.CreateIndex(
                name: "IX_BranchRooms_RoomTypeId",
                table: "BranchRooms",
                column: "RoomTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReseverationDetails_ReservationsId",
                table: "ReseverationDetails",
                column: "ReservationsId");

            migrationBuilder.CreateIndex(
                name: "IX_ReseverationDetails_RoomTypeId",
                table: "ReseverationDetails",
                column: "RoomTypeId");
